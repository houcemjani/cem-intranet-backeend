...
//                        result.put("list", this.trialRepository.findByWord(filters.getWord().trim(), pageable).getContent());
//                        result.put("totalRecords", this.trialRepository.findByWord(filters.getWord().trim(), pageable).getTotalElements());
//                    } else {
//                        result.put("list", this.trialRepository.findAllTrials(pageable).getContent());
//                        result.put("totalRecords", this.trialRepository.findAllTrials(pageable).getTotalElements());
//                    }
